...
public class no3_3 extends Frame {
  // Constructor
  no3_3() {
  ...
  public void paint(Graphics g) {
    ...
    drawDashedLine(g2d, 100, 120, 90, 140);
    ...
    // Draw control points for the quadratic curve
    drawDashedLine(g2d, 180, 120, 170, 140);
    ...
    drawDashedLine(g2d, 160, 80, 195, 100);
    drawDashedLine(g2d, 160, 80, 200, 80);
  ...
  public void drawDashedLine(Graphics2D g2d, int x1, int y1, int x2, int y2) {
    // Dashed line pattern
    float[] dashPattern = { 5 }; // Adjust the length of dashes by changing the value

    // Set dashed stroke
    g2d.setStroke(new BasicStroke(3.0f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL, 0, dashPattern, 0));
